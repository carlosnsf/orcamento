    ...
    <div class="tabs-container">
        ...
        <div id="tab-aprovados" class="tab-content active">
           <div class="table-wrapper">
                <table>
                    <thead>
                        <tr><th>Lançamento</th><th>Centro Custo</th><th>Usuário</th><th>Valor Realizado (R$)</th><th>Data Pag.</th></tr>
                    </thead>
                    <tbody>
        ...
        <body>
            <div class="header-info">
                ...
                <div style="text-align: right;">
                    <p><strong>Usuário:</strong> <?php echo htmlspecialchars($_SESSION['nome'] ?? 'Admin'); ?></p>
                </div>
            </div>
